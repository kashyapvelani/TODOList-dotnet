            ...
            <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div class="relative flex h-16 items-center justify-between">
                    ...
                    <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        <a href="Register.aspx" class="text-white bg-red-700 hover:border-2 hover:bg-red-900 rounded-md px-3 py-2 text-sm font-medium">Sign up</a>
        ...
        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form class="space-y-6" id="form1" runat="server">
                    ...
                    <div>
                        <asp:Button ID="Button1" runat="server" Text="Sign In" OnClick="TODOLogin" CssClass="flex w-full justify-center rounded-md bg-red-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" />
                    </div>
                </form>
