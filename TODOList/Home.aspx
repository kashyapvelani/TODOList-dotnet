...
<body>
                    ...
                    <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div class="hidden sm:ml-6 sm:block">
                            <div class="flex space-x-4">
                                ...
                                <a href="Home.aspx" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container d-flex flex-row bg-red-50 py-10">
            <div class="w-50 mt-20 mx-20 ">
                <h1 class="text-6xl font-bold mb-3">
                    Organize your work<br>
                     and life, finally.
                </h1>
                <h5 class="text-xl font-medium mb-2">Become focused, organized, and calm with Todoist.</h5>
                <p class="text-lg mb-3 text-gray-500">The world’s #1 task manager and to-do list app.</p>
                <a class="btn btn-danger btn-lg rounded-full px-5 py-3" href="Login.aspx">START FOR FREE</a>
            </div>
            <div class="py-20 pr-20">
                <img src="https://res.cloudinary.com/imagist/image/fetch/f_auto/q_auto/c_scale,w_1536/https://todoist.com/static/home-teams/intro/desktop/background.en.jpg?_a=BATCtdcY0" class="h-96" >  
            </div>
        </div>
</body>
</html>
